...
export const studentAttendance = pgTable("student_attendance", {
  ...
  marked_by: integer("marked_by").notNull().references(() => teachers.id),
});
...
export const assignmentSubmissions = pgTable("assignment_submissions", {
  id: serial("id").primaryKey(),
  assignment_id: integer("assignment_id").notNull().references(() => assignments.id),
  student_id: integer("student_id").notNull().references(() => students.id),
...
export const examSubjects = pgTable("exam_subjects", {
  id: serial("id").primaryKey(),
  exam_id: integer("exam_id").notNull().references(() => exams.id),
  subject_id: integer("subject_id").notNull().references(() => subjects.id),
...
export const marks = pgTable("marks", {
  id: serial("id").primaryKey(),
  student_id: integer("student_id").notNull().references(() => students.id),
  exam_subject_id: integer("exam_subject_id").notNull().references(() => examSubjects.id),
